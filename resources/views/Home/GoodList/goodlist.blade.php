			...
			<ul>
				...
				<li>
					<div class="lieb_neir_kuang">
						<div class="lieb_img">
							<a href="/goodinfo/{{$val->id}}"><img src="{{$val->g_pic}}"></a>
							<div class="p_focus"><a class="J_focus" href="/#"><i></i>关注</a></div>
						</div>
						<div class="lieb_text">
							<div class="p_price">
				              	<strong class="J_price"><em>¥</em><i>{{$val->price}}</i><em class="shangp_yuanj zuo_ji">¥</em><i class="shangp_yuanj">1099.00</i></strong>
				            </div>
						</div>
						<div class="shangp_biaot_"><a href="/#">{{$val->name}}</a></div>
