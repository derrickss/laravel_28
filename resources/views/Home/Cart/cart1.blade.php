...
<div class="container">
	...
	<div class="cart-shop-goods dangq_honh">
		<div class="cart-shop-good">
			...
			<div class="fl houj_c">
				<div class="cart-dfsg"><div class="cart-good-name"><a href="/#" target="_blank">{{$val->name}}</a></div></div>
				<div class="cart-good-pro"></div>
				<div class="cart-col-4"><div class="cart-good-real-price "><!--主品-->¥&nbsp;{{$val->price}}</div><div class="red"></div></div>
