	...
	<div class="beij_center dengl_jvz">
		<div class="login_form">
			...
			<div class="kengl_kuang">
				<div class="txt_kuang">
					<input type="text" class="itxt"  placeholder="邮箱/用户名/已验证手机" name="user_name" value="{{old('user_name')}}">
					<input type="password" class="itxt"  placeholder="密码" name="password" value="">
				</div>
				<div class="remember">
					<div class="fl">
						<input type="checkbox" >
