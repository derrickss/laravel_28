...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 轮播图and广告管理 <span class="c-gray en">&gt;</span> 轮播图and广告列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c">
		<form class="Huiform" id="form-admin-add" method="post" action="/lunbo" target="_self" enctype="multipart/form-data">

			<input type="text" name="name" placeholder="名称" value="" class="input-text" style="width:120px">
			<span class="btn-upload form-group">
			<input class="input-text upload-url" type="text" name="pic" id="uploadfile-2" readonly style="width:200px">
			...
			<select class="select" name="cate" size="1">
		...
		<table class="table table-border table-bordered table-bg table-sort">
			...
			@foreach($info as $k)
				<tr class="text-c">
					...
					@endif
					<a style="text-decoration:none" onClick="product_brand_edit('轮播图广告编辑','/lunbo/{{$k->id}}/edit','{{$k->id}}','1000','170')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function admin_stop(obj,id,sta){
	layer.confirm('确认要停用吗？',function(index){
		// alert(id);
		$.get('/lunbostatus',{id:id,sta:sta},function(data) {
