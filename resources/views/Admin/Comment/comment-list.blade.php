		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td>{{$row->id}}</td>
					<td class="text-l">
						<div>{{$row->user_id}}</div></td>
					<td><a href="javascript:;" onclick="member_show('张三','member-show.html','10001','360','400')">{{$row->user_name}}</a></td>
					<td class="text-l">
						<div>{{$row->content}}</div></td>
					<td class="text-l">
						<div>{{$row->reply}}</div></td>
					<td class="td-manage"><a title="回复" href="javascript:;" onclick="member_edit('回复','/comment/{{$row->id}}/edit','4','','510')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="member_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
				@endforeach
			</tbody>
		</table>
