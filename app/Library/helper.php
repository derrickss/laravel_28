...
function message($p){
	...
	$options['accountsid']='1d0a517a4a9f26daa206bd763f3c5cb0';
	//填写在开发者控制台首页上的Auth Token
	$options['token']='65d55d1207e071543405964f2073c576';

	//初始化 $options必填
	$ucpass = new Ucpaas($options);
	$appid = "ca2eb6a8d6004091af555ef3eca9c8eb";	//应用的ID，可在开发者控制台内的短信产品下查看
	//短信模板id (必须通过审核)
	$templateid = "373954";    //可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID
	//短信校验码
	$param = rand(1000,10000);
	//存储在cookie 1分钟后过期
